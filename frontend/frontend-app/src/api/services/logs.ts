...
import type { LogEntry, LogsQueryParams } from '@/stores/logs'
...
export const logsApi = {
  ...
  clear: (params?: {
    ...
    return apiClient.post('/logs/clear', params)
  },
  ...
  getStream: (params?: {
    ...
    return apiClient.get('/logs/stream', {
      params,
      responseType: 'stream'
    })
  },
  ...
  updateLevels: (levels: Record<string, string>) => {
    return apiClient.put('/logs/levels', levels)
  },

  // 获取日志源列表
  getSources: () => {
    return apiClient.get('/logs/sources')
  },

  // 获取系统健康状态
  getHealthStatus: () => {
    return apiClient.get('/logs/health')
  },
  ...
  getErrorTrends: (params?: {
    ...
    return apiClient.get('/logs/trends/errors', { params })
  },
  ...
  getPerformanceMetrics: (params?: {
    ...
    return apiClient.get('/logs/metrics/performance', { params })
  }
}