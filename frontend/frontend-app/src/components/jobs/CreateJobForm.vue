            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <n-form-item label="选择文件" path="file">
                        <FileUpload v-model:file="formData.file" accept=".pdf,.doc,.docx,.txt,.jpg,.jpeg,.png"
                            :max-size="50 * 1024 * 1024" @change="handleFileChange" />
                    </n-form-item>
                </div>

                <!-- 打印机选择 -->
                <n-form-item label="选择打印机" path="printerId">
                    <n-select v-model:value="formData.printerId" :options="printerOptions" placeholder="请选择打印机"
                        @update:value="handlePrinterChange" />
                </n-form-item>

                <!-- 份数 -->
                <n-form-item label="打印份数" path="copies">
                    <n-input-number v-model:value="formData.copies" :min="1" :max="99" placeholder="1" />
                </n-form-item>
                ...
                <n-form-item label="纸张大小" path="settings.paperSize">
                    <n-select v-model:value="formData.settings.paperSize" :options="paperSizeOptions"
                        placeholder="请选择纸张大小" />
                </n-form-item>
                ...
                <n-form-item label="打印质量" path="settings.quality">
                    <n-select v-model:value="formData.settings.quality" :options="qualityOptions"
                        placeholder="请选择打印质量" />
                </n-form-item>

                <!-- 彩色打印 -->
                <n-form-item label="彩色打印" path="settings.color">
                    <n-switch v-model:value="formData.settings.color" :disabled="!selectedPrinterSupportsColor" />
                ...
                <n-form-item label="双面打印" path="settings.duplex">
                    <n-switch v-model:value="formData.settings.duplex" :disabled="!selectedPrinterSupportsDuplex" />
            ...
            <div v-if="formData.file" class="mt-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    <div class="flex items-center space-x-4">
                        <div
                            class="w-16 h-16 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
